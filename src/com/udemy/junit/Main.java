...
import com.udemy.junit.negocio.Cliente;
import com.udemy.junit.negocio.ContaCorrente;
import com.udemy.junit.negocio.GerenciadoraClientes;
import com.udemy.junit.negocio.GerenciadoraContas;
...
public class Main {
	 ...
	 * apenas para realização de testes manuais atraves do metodo main acima.
	 */
	private static void inicializaSistemaBancario() {
		...
		Cliente cliente01 = new Cliente(1, "Eduardo Freitas", 24, "eduardo@gmail.com", conta01.getId(), true);
		Cliente cliente02 = new Cliente(2, "John Doe", 40, "john@gmail.com", conta02.getId(), true);
